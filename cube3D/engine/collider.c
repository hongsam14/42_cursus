...
/*   Updated: 2021/03/06 15:07:33 by suhong           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		collider(t_game *game)
{
	...
	if (game->world.map_data[game->world.w * (int)map.y + (int)map.x] == 1)
	{
		...
		if (game->world.map_data[game->world.w * (int)map.y +
				(int)map.x + (int)push.x] == 1)
			game->player.pos.y = game->player.old_pos.y;
		if (game->world.map_data[game->world.w *
